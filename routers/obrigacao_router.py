...
from services.obrigacao_service import create_obrigacao, get_obrigacoes, get_obrigacao, update_obrigacao, delete_obrigacao
from database import get_db
from sqlalchemy.orm import Session
from schemas.obrigacao_schema import ObrigacaoBase, Obrigacao
